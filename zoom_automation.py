...
while(True):
    ...
    if timestr in df.Time.values:
        ...
        position = pyautogui.locateOnScreen(
            "Zoom_automation_folder\\join_button.png")
        ...
        position = pyautogui.locateOnScreen(
            "Zoom_automation_folder\\turn_off_vid_button.png")
        pyautogui.moveTo(position)
        pyautogui.click()
        time.sleep(2)
        ...
        position = pyautogui.locateOnScreen(
            "Zoom_automation_folder\\join_button_2.png")
        pyautogui.moveTo(position)
        pyautogui.click()
        time.sleep(7)
        ...
        position = pyautogui.locateOnScreen(
            "Zoom_automation_folder\\join_meeting.png")
        pyautogui.moveTo(position)
        pyautogui.click()
